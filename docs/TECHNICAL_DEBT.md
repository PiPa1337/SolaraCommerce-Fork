...
| P2 | Abierto (plan mejora arquitectónica 2026-08-21): `exporter/src/index.ts` conserva renderDocument/buildPages/buildFiles (~2300 líneas) tras extraer html/urls/whatsapp/assets/structured-data/feeds. | El núcleo de render sigue concentrando rutas y semántica. | Continuar extracción por página (`pages/home.ts`, `pages/product.ts`, etc.) manteniendo index.ts como barrel; cada extracción con parity/determinism verdes. |
