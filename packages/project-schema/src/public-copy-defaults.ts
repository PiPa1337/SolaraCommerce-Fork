...
export const PUBLIC_COPY_DEFAULTS = {
  ...
  contact: {
    ...
    success: "Listo",
    reasonLabel: "Tema de consulta",
    optionsAction: "Ver opciones de contacto",
    email: "Email",
    phone: "Teléfono",
    whatsapp: "WhatsApp",
    address: "Dirección",
    ...
    javascriptFallback: "Activá JavaScript o usá los enlaces para enviar la consulta.",
    whatsappAction: "Escribir por WhatsApp",
    reason: "Motivo",
  ...
  footer: {
    ...
    madeWith: "Hecho con ❤️ en solara.com.ar",
  },
  empty: {
    products: "No hay productos para mostrar.",
    collections: "Todavía no hay colecciones publicadas.",
    cart: "Tu carrito está vacío.",
    categories: "Todavía no hay categorías para mostrar.",
    page: "No hay contenido publicado.",
  ...
  accessibility: {
    ...
    testimonialsControls: "Controles de testimonios",
